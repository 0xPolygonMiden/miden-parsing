...
pub mod symbols {
    ...
    pub const Module: Symbol = Symbol::new(2);
    pub const Lambda: Symbol = Symbol::new(3);
    pub const Let: Symbol = Symbol::new(4);
    pub const Def: Symbol = Symbol::new(5);
    pub const Main: Symbol = Symbol::new(6);

    pub(super) const __SYMBOLS: &'static [(Symbol, &'static str)] = &[
        (False, "false"),
        (True, "true"),
        (Module, "module"),
        (Lambda, "lambda"),
